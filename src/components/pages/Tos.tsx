...
const Tos: VFC = memo(() => (
  <>
    ...
    <Text>
      この利用規約（以下，「本規約」といいます。）は，DuelMatching運営者（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
    </Text>
    ...
    <OrderedList>
      ...
      <ListItem>以下を目的とし，または目的とすると当社が判断する行為</ListItem>
      <OrderedList marginY="10px">
        <ListItem>
    ...
    <Text marginTop="20px" textAlign="right">
      以上
    </Text>
    <Center marginY="20px">
