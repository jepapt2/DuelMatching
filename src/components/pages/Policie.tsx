...
const Policie: VFC = memo(() => (
  <>
    <Heading size="xl">プライバシーポリシー</Heading>
    DuelMatching運営者(以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
    <Heading size="xl" marginY="20px">
      第1条（個人情報）
    </Heading>
    <Text>
    ...
    <Link href="https://twitter.com/jepapt2" color="blue.500">
      Twitter
    </Link>
    <Text textAlign="right" marginTop="20px">
      以上
    </Text>
    <Center marginY="20px">
